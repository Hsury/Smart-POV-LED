/*
 * Project Name: Smart POV LED (Basic Edition)
 * Software Version: 2017/02/21
 */
#define element 1024 //1024 = 128 * 64 / 8  (2-bit HEX = 16-bit BIN)
#define ver "2017/02/19" //Version
...
void selftest() {
  ...
  digitalWrite(latchPin, LOW);
  for (i = 0; i < 8; i++) {
    shiftOut(dataPin, clockPin, MSBFIRST, 0xFF); //Turn off all LED
  }
  digitalWrite(latchPin, HIGH);
}
